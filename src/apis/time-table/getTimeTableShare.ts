...
type GetTimeTableShareResponse = components['schemas']['TimeTableEntityView'] | null;

export default async function getTimeTableShare(
    uuid: string
    ...
    try {
        ...
        let message = '시간표 정보를 불러오지 못했습니다.';
