...
const MessageBody: React.FC<Props> = ({ userMe, userOther }) => {
  ...
  return (
    <div
      ...
      className="flex flex-col px-5 bg-gray-20 h-[380px] pb-3 space-y-2 overflow-y-auto overflow-x-hidden overscroll-contain"
