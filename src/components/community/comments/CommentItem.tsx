...
import { Comment } from '../post/Post.types';
import CommentActions from './CommentActions';
import CommentForm from './CommentForm';
import editComment from '../../../apis/community/comments/editComment';
import deleteComment from '../../../apis/community/comments/deleteComment';
import {
  COOKIE_NS,
          ...
          <div className="flex items-center justify-between pt-5 pb-3">
            <div className="flex items-center gap-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className={`${isMobile?'text-semibold-12':'text-bold-14'} ${
                  isPostAuthor
                    ? 'text-normal'
                    : 'text-gray-90'
                }`}>
