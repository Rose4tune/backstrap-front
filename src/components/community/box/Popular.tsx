...
import BurningIcon from '@assets/icons/community/burning.svg';
...
export default function Popular({ title, count = 7, iconUrl }: CategoryProps) {
    ...
    <div className="w-full min-w-0">
      <div className="flex flex-col gap-4 px-5 py-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <Link href={`/community/popular?sortType=POPULAR&name=가장 핫한 인기글`}>
