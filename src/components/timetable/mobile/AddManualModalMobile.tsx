...
function AddManualModalMobile(props: ManualModalProps) {
    ...
    async function handleAddClass() {
        if (!isFormValid || !timeTableUuid || !accessToken) {
            return;
        }
    ...
    return (
        <>
            ...
            <div className="mx-auto max-w-[550px] w-full max-h-[500px] overflow-y-auto no-scrollbar flex flex-col gap-5 fixed left-1/2 -translate-x-1/2 bottom-0 px-[20px] pt-[28px] pb-[36px] bg-white rounded-t-[24px] z-[1001]">
...
export default observer(AddManualModalMobile)