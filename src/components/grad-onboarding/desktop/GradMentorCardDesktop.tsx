...
export default function GradMentorCardDesktop({ mentor, handleBookmark }: MentorCardProps) {
        ...
        >
            ...
            <div className="flex justify-between">
                ...
                <button
                    ...
                    className="bg-gray-20 rounded-[16px] justify-center items-center w-[52px] h-[52px]"
                >
                    <BookmarkIcon
                        width={28}
                        height={28}
