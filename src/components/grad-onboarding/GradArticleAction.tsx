...
import { registerLike, deleteLike, registerScrap, deleteScrap } from '@api/community/userInteraction';
...
import { PostActionsProps } from '../community/post/Post.types';

export default function GradArticleAction({
    interaction,
    postUuid,
    accessToken,
    onLike,
    ...
    return (
        <div className={`flex items-center ${isMobile ? 'justify-between px-5 pt-5' : 'gap-x-1 ml-[-20px] pt-[52px]'}`}>
            ...
            <button
                ...
                className={`${isMobile ? 'text-semibold-12 px-2' : 'pl-4 pr-5 text-semibold-14'} flex flex-shrink-0 justify-center items-center gap-1 py-2 rounded-2xl transition-colors hover:bg-red-50 ${interaction.isLiked ? 'text-red' : 'text-gray-40 hover:text-white'
            ...
            <button
                ...
                className={`${isMobile ? 'text-semibold-12 px-2' : 'pl-4 pr-5 text-semibold-14'} flex flex-shrink-0 justify-center items-center gap-1 py-2 rounded-2xl transition-colors hover:bg-amber-100 ${interaction.isScraped ? 'text-yellow' : 'text-gray-40 hover:text-white'
