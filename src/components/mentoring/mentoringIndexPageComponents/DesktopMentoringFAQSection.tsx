...
export default function DesktopMentoringFAQSection() {
  ...
  return (
    <div>
      <div className="text-bold-24 text-gray-90 text-center">자주 묻는 질문</div>
      <div className="flex flex-col w-full gap-[20px] px-[80px] mb-[86px]">
        {/* FAQ Toggle Section*/}
        {/* 첫번째 toggle 버튼 */}
        <button
          onClick={() => {
        ...
        >
          <div className="flex flex-1 w-full justify-between items-center py-[16px] pl-[8px] pr-[20px] border-b-[1px] border-gray-40">
            <p className="text-bold-16 text-gray-90">결제 했는데 그 다음은 어떡하나요?</p>
            {isFirstOpen ? (
        ...
        {isFirstOpen && (
          <div className="flex flex-col px-[20px]">
            <p className="text-med-14 text-gray-70 mb-[12px]">
              결제를 완료하면, 영업일 1일 이내에 입력하신 연락처로 멘토링 일정, 질문지,
              그리고 참여 URL을 전달드립니다.
            </p>
            <p className="text-semibold-16 text-gray-90 mb-[4px]">
              알림톡을 받지 못했어요!
            </p>
            <p className="text-med-14 text-gray-70 mb-[12px]">
        ...
        >
          <div className="flex w-full justify-between items-center py-[16px] pl-[8px] pr-[20px] border-b-[1px] border-gray-40">
            <p className="text-bold-16 text-gray-90">결제 했는데 멘토를 바꾸고 싶어요!</p>
            {isSecondOpen ? (
              <TextBoxUpIcon width={20} height={20} />
            ) : (
              <TextBoxDownIcon width={20} height={20} />
        ...
        >
          <div className="flex w-full justify-between items-center py-[16px] pl-[8px] pr-[20px] border-b-[1px] border-gray-40">
            <p className="text-bold-16 text-gray-90">멘토링은 어디에서 진행되나요?</p>
            {isFourthOpen ? (
              <TextBoxUpIcon width={20} height={20} />
            ) : (
              <TextBoxDownIcon width={20} height={20} />
        ...
        >
          <div className="flex w-full justify-between items-center py-[16px] pl-[8px] pr-[20px] border-b-[1px] border-gray-40">
            <p className="text-bold-16 text-gray-90">환불 규정이 어떻게 되나요?</p>
            {isFifthOpen ? (
              <TextBoxUpIcon width={20} height={20} />
            ) : (
              <TextBoxDownIcon width={20} height={20} />
